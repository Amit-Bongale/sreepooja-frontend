...
import AddCity from "../../../components/staff/contentManager/Locations/AddCity";
import EditCity from "../../../components/staff/contentManager/Locations/EditCity";
...
function ManageCities() {
  ...
  const fetchLocations = async () => {
    const data = await getData(`/admin/masters/states/${stateId}/cities`);
      ...
      <div className="overflow-x-auto p-4">
        {filteredData.length > 0 ? (
              ...
              {filteredData.map((data) => (
                <tr key={data.id} className="hover:bg-gray-50/50">
                  <td className="px-6 py-4 text-gray-500 font-mono text-xs">
                    CA-{data.id.toString().padStart(2, "0")}
                  </td>
          ...
          <div className="flex flex-col items-center min-h-[70vh] justify-center gap-2 py-10">
            ...
            <h2 className="text-lg font-bold text-gray-900">No Cities Found</h2>
            <p className="text-gray-500 text-center">
              Try adjusting your search or add new Cities.
            </p>
            <button
              onClick={() => setIsAddModalOpen(true)}
