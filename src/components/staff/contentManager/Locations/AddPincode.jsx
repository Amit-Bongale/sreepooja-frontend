...
function AddPincode({ label, cityId, setIsAddModalOpen, onSucess }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/admin/masters/cities/${cityId}/pincodes`,
        {
          method: "POST",
          headers: {
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setData({
                  ...data,
                    pincodes: e.target.value.split(",").map((code) => code.trim()),
                });
              }}
