        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden card-hover group relative flex flex-col">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-4 flex-1">
                Purify your new home and invite prosperity, peace, and positive
                energy before moving in with traditional Vedic mantras.
              </p>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden card-hover group relative flex flex-col">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-4 flex-1">
                Express gratitude and seek blessings from Lord Vishnu. Ideal for
                birthdays, anniversaries, or new beginnings.
              </p>
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                <span className="text-sm font-medium text-gray-500">
                  Starts at ₹2,100
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden card-hover group relative flex flex-col">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-4 flex-1">
                A sacred naming ceremony to bless the newborn child with a
                meaningful name based on Vedic astrology.
              </p>
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                <span className="text-sm font-medium text-gray-500">
                  Starts at ₹2,500
